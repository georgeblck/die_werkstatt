...
<a target="_blank" href="https://statistikwerkstatt.org/info">
...
m <- leaflet(width = "100%", height = "500px", padding = 2) %>%
  ...
  addMarkers(lng=12.314049, lat=51.347738, icon = statIcon, popup='<a href="https://statistikwerkstatt.org/info">Klick mich</a>') %>%
